...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="hero-section">
    ...
    <div class="hero-content-wrapper">
      <div class="hero-text-card wsite-content-elem">
        {element}
      </div>
    </div>
  </section>

  <!-- Who We Are — drag-drop editable in Weebly editor -->
  <div class="wsite-section who-we-are-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Our Impact (Green PNG bg) — drag-drop editable in Weebly editor -->
  <div class="wsite-section impact-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Centering Our Community — drag-drop editable in Weebly editor -->
  <div class="wsite-section centering-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Wellness Offerings — drag-drop editable in Weebly editor -->
  <div class="wsite-section wellness-offerings-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Become a Villager / Village Keeper — drag-drop editable in Weebly editor -->
  <div class="wsite-section villager-keeper-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Our Partners Logos — drag-drop editable in Weebly editor -->
  <div class="wsite-section partners-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
