...
<head>
  ...
  <title>Our Impact — It Takes A Village Collaborative</title>
  <meta name="description" content="The measurable impact of ITAVCollab wellness programming." />
  %%wsite_css%%
...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="page-hero">
    <img class="page-hero-bg" src="assets/images/impact-hero.jpg" alt="Community members at ITAVCollab event" />
    <div class="page-hero-overlay" aria-hidden="true"></div>
    <div class="page-hero-content">
      <h1 class="page-hero-title">Our Impact</h1>
    </div>
  </section>
  <!-- Impact Stats — Green PNG bg — drag-drop editable in Weebly editor -->
  <div class="wsite-section impact-stats-section-1">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Impact Stats — Gold bg — drag-drop editable in Weebly editor -->
  <div class="wsite-section impact-stats-section-2">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Impact Stats — Green PNG bg — drag-drop editable in Weebly editor -->
  <div class="wsite-section impact-stats-section-3">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Testimonials — Slider — drag-drop editable in Weebly editor -->
  <div class="wsite-section impact-testimonial">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Newsletter CTA — drag-drop editable in Weebly editor -->
  <div class="wsite-section impact-newsletter">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Results Through Approach — drag-drop editable in Weebly editor -->
  <div class="wsite-section impact-approach">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
