...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="page-hero">
    <img class="page-hero-bg" src="assets/images/gi-hero.jpg" alt="Community members at ITAVCollab event" />
  ...
  <!-- Support Our Work Row — drag-drop editable in Weebly editor -->
  <div class="wsite-section gi-row">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Partner With Us Row — drag-drop editable in Weebly editor -->
  <div class="wsite-section gi-row">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Become an Intern Row — drag-drop editable in Weebly editor -->
  <div class="wsite-section gi-row">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Join a Wellness Experience Grid — drag-drop editable in Weebly editor -->
  <div class="wsite-section gi-wellness">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
