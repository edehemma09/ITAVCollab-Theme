...
<head>
  ...
  <title>Get Involved — It Takes A Village Collaborative</title>
  <meta name="description" content="Donate, partner, intern, or join a wellness experience." />
  %%wsite_css%%
...
<section class="page-hero" aria-label="Get Involved">
      <img class="page-hero-bg" src="assets/images/gi-hero.jpg" alt="Community members at an ITAVCollab event" />
      <div class="page-hero-overlay" aria-hidden="true"></div>
      <div class="page-hero-content">
        <h1 class="page-hero-title">Get Involved</h1>
        <p class="page-hero-subtitle">Explore All The Ways You Can Get Involved With It Takes A Village Collaborative</p>
      </div>
    </section>
    <section class="gi-row" aria-label="Support Our Work">
      <div class="gi-row-inner">
        <div class="gi-row-image"><img src="assets/images/gi-support.jpg" alt="ITAVCollab wellness table display" loading="lazy" /></div>
        <div class="gi-row-content">
          <h2 class="gi-row-heading">Support Our Work</h2>
          <p class="gi-row-body">Help ITAVCollab continue our mission to bring healing and accessible, sustainable wellness to communities by donating today.</p>
          <a href="donate.html" class="btn btn-green">Donate</a>
        </div>
      </div>
    </section>
    <section class="gi-row" aria-label="Partner With Us">
      <div class="gi-row-inner">
        <div class="gi-row-image"><img src="assets/images/gi-partner.jpg" alt="ITAVCollab partners gathered together" loading="lazy" /></div>
        <div class="gi-row-content">
          <h2 class="gi-row-heading">Partner With Us</h2>
          <p class="gi-row-body">Join our other ITAVCollab partners and bring wellness to your organization.</p>
          <a href="partner.html" class="btn btn-green">Become a Partner</a>
        </div>
      </div>
    </section>
    <section class="gi-row" aria-label="Become an Intern">
      <div class="gi-row-inner">
        <div class="gi-row-image"><img src="assets/images/gi-intern.jpg" alt="ITAVCollab interns group photo" loading="lazy" /></div>
        <div class="gi-row-content">
          <h2 class="gi-row-heading">Become an Intern</h2>
          <p class="gi-row-body">Apply to our ITAVCollab internship program to earn valuable experiences and employable skills in integrative wellness, social justice, community care, and nonprofit development.</p>
          <a href="internships.html" class="btn btn-green">Internships</a>
        </div>
      </div>
    </section>
    <section class="gi-wellness" aria-label="Join a Wellness Experience">
      <div class="gi-wellness-inner">
        <h2 class="gi-wellness-heading">Join a Wellness Experience</h2>
        <p class="gi-wellness-sub">Experience holistic wellness firsthand by participating in one of our ITAVCollab programs or by joining an event.</p>
        <div class="gi-wellness-grid">
          <a href="programs.html" class="gi-wellness-card" aria-label="Explore Our Programs">
            <div class="gi-wellness-image"><img src="assets/images/gi-programs.jpg" alt="ITAVCollab programs" loading="lazy" /></div>
            <div class="gi-wellness-label">Explore Our Programs</div>
          </a>
          <a href="events.html" class="gi-wellness-card" aria-label="Join an Event">
            <div class="gi-wellness-image"><img src="assets/images/gi-events.jpg" alt="ITAVCollab outdoor event" loading="lazy" /></div>
            <div class="gi-wellness-label">Join an Event</div>
          </a>
        </div>
      </div>
    </section>
