...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="page-hero">
    <img class="page-hero-bg" src="assets/images/hj-hero.jpg" alt="Community members at Healing Justice event" />
  ...
  <!-- Personal Healing — Text + Image — drag-drop editable in Weebly editor -->
  <div class="wsite-section hj-intro">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Reentry &amp; Identity Reconstruction — drag-drop editable in Weebly editor -->
  <div class="wsite-section hj-reentry">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- What We Offer — Image + Card — drag-drop editable in Weebly editor -->
  <div class="wsite-section hj-offer-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- To Be Me Reentry Cohort — drag-drop editable in Weebly editor -->
  <div class="wsite-section hj-tbm">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- In 8-12 Weeks Grid — drag-drop editable in Weebly editor -->
  <div class="wsite-section hj-weeks">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- TBM Partners + Logos — drag-drop editable in Weebly editor -->
  <div class="wsite-section hj-partners">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
