...
<head>
  ...
  <title>Connect With Us — It Takes A Village Collaborative</title>
  <meta name="description" content="Contact ITAVCollab, subscribe to our newsletter, and follow on social media." />
  %%wsite_css%%
...
<!-- 1. HERO — centered title over group photo -->
    <section class="page-hero" aria-label="Connect With Us">
      <img class="page-hero-bg" src="assets/images/connect-hero.jpg" alt="Four women smiling together at an ITAVCollab event" />
      <div class="page-hero-overlay" aria-hidden="true"></div>
      <div class="page-hero-content">
        <h1 class="page-hero-title">Connect With Us</h1>
      </div>
    </section>

    <!-- 2. CONTACT FORM SECTION -->
    <section class="connect-form-section" aria-label="Contact Form">
      <div class="connect-form-inner">
        <div class="connect-form-header">
          <h2 class="connect-form-heading">We'd Love to Hear From You</h2>
          <p class="connect-form-subheading">Whether you have a question, feedback, or just want to say hello, don't hesitate to reach out to us.</p>
        </div>

        <div class="connect-form-cols">

          <!-- LEFT: Contact form — Weebly form element compatible -->
          <div class="connect-form-left">
            <!--
              WEEBLY FORM NOTE:
              In Weebly editor, replace this <form> with a Weebly Form element.
              The classes below match Weebly's default form output so styling
              is applied automatically when the Weebly Form element is added.
            -->
            <form
              class="wsite-form"
              id="contact-form"
            ...
            >
              ...
              <div class="cf-field-group">
                <label class="cf-label" for="first-name">Name</label>
                <div class="cf-name-row">
                  <div class="cf-field">
                    <input
                      class="wsite-form-input cf-input"
                      type="text"
                      id="first-name"
                      name="first_name"
              ...
              <div class="cf-two-col">
                ...
                <div class="cf-field-group">
                  <label class="cf-label" for="phone">Phone Number</label>
                  <input
                    class="wsite-form-input cf-input"
                    type="tel"
                    id="phone"
              ...
              <div class="cf-field-group">
                ...
                <textarea
                  class="wsite-form-input cf-textarea"
                  id="message"
                  name="message"
                  rows="5"
                ></textarea>
              ...
              <!-- Submit -->
              <button type="submit" class="btn btn-green cf-submit">Submit</button>
            </form>
          </div>

          <!-- RIGHT: Stay in the loop opt-in -->
          <div class="connect-form-right">
            <p class="connect-optin-heading"><span class="connect-optin-green">Stay in the loop!</span> Sign up for exclusive updates, promotions, and news. Select all that apply:</p>

            <div class="connect-optin-list">
              <label class="connect-optin-item">
                <input type="checkbox" class="connect-checkbox" name="optin_email" />
                <span class="connect-optin-text">Yes, I'd like to receive emails with news, updates, and offers.</span>
              </label>
              <label class="connect-optin-item">
                <input type="checkbox" class="connect-checkbox" name="optin_sms" />
                <span class="connect-optin-text">Yes, send me text messages with special offers and updates.</span>
              </label>
              <label class="connect-optin-item">
                <input type="checkbox" class="connect-checkbox" name="optin_none" />
                <span class="connect-optin-text">No, I do not want to stay in the loop.</span>
              </label>
            </div>

            <p class="connect-optin-disclaimer">No email or mobile data will be shared with third parties/affiliates for marketing/promotional purposes at any time.</p>
          </div>
    ...
    <section class="connect-other" aria-label="Other Ways to Connect">
      <div class="connect-other-inner">
        <h2 class="connect-other-heading">Looking for Other Ways to Connect with ITAVCollab?</h2>
        <p class="connect-other-sub">Explore the ways you can keep up with all things ITAVCollab.</p>

        <div class="connect-channels">

          <!-- Newsletter signup row -->
          <div class="connect-channel-row">
            <div class="connect-channel-left">
              <h3 class="connect-channel-heading">Village Newsletter</h3>
              <p class="connect-channel-body">Keep up with ITAVCollab by signing up for our quarterly Village newsletter.</p>
              <form class="connect-newsletter-form wsite-form" action="#" method="POST">
                <div class="connect-newsletter-row">
                  <input
                    class="wsite-form-input connect-newsletter-input"
                    type="email"
                  ...
                  />
                  <button type="submit" class="btn btn-green connect-newsletter-btn">Submit</button>
                </div>
              </form>
            </div>
            <div class="connect-channel-right">
              <div class="connect-social-card">
                <h3 class="connect-social-heading">Social Media</h3>
                <p class="connect-social-sub">Follow @itavcollab on our socials.</p>
                <div class="connect-social-icons">
                  <a href="https://instagram.com/itavcollab" class="connect-social-icon" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                    <svg width="32" height="32" viewBox="0 0 40 40" fill="none"><rect x="5" y="5" width="30" height="30" rx="8" stroke="white" stroke-width="2.5"/><circle cx="20" cy="20" r="7" stroke="white" stroke-width="2.5"/><circle cx="29" cy="11" r="2" fill="white"/></svg>
                  </a>
                  <a href="https://linkedin.com/company/itavcollab" class="connect-social-icon" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
                    <svg width="32" height="32" viewBox="0 0 40 40" fill="none"><rect x="5" y="5" width="30" height="30" rx="4" stroke="white" stroke-width="2.5"/><path d="M13 17v10M13 13v1M20 27v-5c0-2 1-3 3-3s3 1 3 3v5M20 17v10" stroke="white" stroke-width="2.5" stroke-linecap="round"/></svg>
                  </a>
                  <a href="https://tiktok.com/@itavcollab" class="connect-social-icon" aria-label="TikTok" target="_blank" rel="noopener noreferrer">
                    <svg width="32" height="32" viewBox="0 0 40 40" fill="none"><path d="M22 10c.5 4 3 6 6 6v4c-2 0-4-.5-6-2v8a8 8 0 11-8-8v4a4 4 0 104 4V10h4z" stroke="white" stroke-width="2.5" stroke-linejoin="round"/></svg>
                  </a>
                  <a href="https://youtube.com/@itavcollab" class="connect-social-icon" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
                    <svg width="32" height="32" viewBox="0 0 40 40" fill="none"><rect x="5" y="11" width="30" height="18" rx="5" stroke="white" stroke-width="2.5"/><path d="M17 15l8 5-8 5V15z" fill="white"/></svg>
                  </a>
                  <a href="https://facebook.com/itavcollab" class="connect-social-icon" aria-label="Facebook" target="_blank" rel="noopener noreferrer">
                    <svg width="32" height="32" viewBox="0 0 40 40" fill="none"><circle cx="20" cy="20" r="14" stroke="white" stroke-width="2.5"/><path d="M22 13h-2a4 4 0 00-4 4v2h-2v4h2v8h4v-8h3l1-4h-4v-2a1 1 0 011-1h3v-3z" stroke="white" stroke-width="1.5" stroke-linejoin="round"/></svg>
                  </a>
                </div>
              </div>
            </div>
          ...
          <!-- Podcast row -->
          <div class="connect-podcast-row">
            <div class="connect-podcast-text">
              <h3 class="connect-channel-heading">Queen B.E.E. Talks Podcast</h3>
              <p class="connect-channel-body">Listen to our podcast, Queen B.E.E. Talks, where we have discussions centering Black women and wellness.</p>
              <a href="https://youtube.com/@itavcollab" class="btn btn-green" target="_blank" rel="noopener noreferrer">Watch Podcast</a>
            </div>
            <div class="connect-podcast-image">
              <img src="assets/images/connect-podcast.jpg" alt="Queen B.E.E. Talks podcast - two women in conversation" loading="lazy" />
            </div>
          </div>
