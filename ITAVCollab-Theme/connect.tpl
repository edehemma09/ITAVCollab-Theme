...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="page-hero">
    <img class="page-hero-bg" src="assets/images/connect-hero.jpg" alt="Four women at ITAVCollab event" />
    <div class="page-hero-overlay" aria-hidden="true"></div>
    <div class="page-hero-content">
      <h1 class="page-hero-title">Connect With Us</h1>
    </div>
  </section>
  <!-- Contact Form + Opt-In — drag-drop editable in Weebly editor -->
  <div class="wsite-section connect-form-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Other Ways to Connect — Newsletter + Social + Podcast — drag-drop editable in Weebly editor -->
  <div class="wsite-section connect-other">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
