...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="page-hero">
    <img class="page-hero-bg" src="assets/images/programs-hero.jpg" alt="Woman at ITAVCollab programs event" />
    <div class="page-hero-overlay" aria-hidden="true"></div>
    <div class="page-hero-content">
      <h1 class="page-hero-title">Our Programs</h1>
    </div>
  </section>
  <!-- Wellness Initiatives Row — drag-drop editable in Weebly editor -->
  <div class="wsite-section program-row">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Healing Justice Row — drag-drop editable in Weebly editor -->
  <div class="wsite-section program-row">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Organizational Wellness Row — drag-drop editable in Weebly editor -->
  <div class="wsite-section program-row">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Digital Resources — drag-drop editable in Weebly editor -->
  <div class="wsite-section program-digital">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
