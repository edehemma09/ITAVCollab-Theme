...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="nl-hero">
    ...
    <div class="nl-hero-title-box">
      <h1 class="nl-hero-title">Village Newsletter</h1>
    </div>
  </section>
  <!-- Newsletter Signup Form — drag-drop editable in Weebly editor -->
  <div class="wsite-section nl-signup">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Previous Issues — Year Cards Grid — drag-drop editable in Weebly editor -->
  <div class="wsite-section nl-issues">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
