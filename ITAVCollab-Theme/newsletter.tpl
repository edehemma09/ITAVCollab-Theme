...
<head>
  ...
  <title>Village Newsletter — It Takes A Village Collaborative</title>
  <meta name="description" content="Sign up for the quarterly Village Newsletter and browse previous issues." />
  %%wsite_css%%
...
<section class="nl-hero" aria-label="Village Newsletter">
      <img class="nl-hero-bg" src="assets/images/newsletter-hero.jpg" alt="Colorful crocheted textile" />
      <div class="nl-hero-title-box"><h1 class="nl-hero-title">Village Newsletter</h1></div>
    </section>
    <section class="nl-signup" aria-label="Newsletter Signup">
      <div class="nl-signup-inner">
        <h2 class="nl-signup-heading">Village Newsletter</h2>
        <p class="nl-signup-body">Keep up with ITAVCollab by signing up for our quarterly Village newsletter.</p>
        <form class="nl-signup-form wsite-form" action="#" method="POST">
          <div class="nl-form-row">
            <input class="wsite-form-input nl-input" type="email" name="email" placeholder="Email Address" autocomplete="email" aria-label="Email address" />
            <button type="submit" class="btn btn-green nl-submit-btn">Submit</button>
          </div>
        </form>
      </div>
    </section>
    <section class="nl-issues" aria-label="Previous Newsletter Issues">
      <div class="nl-issues-inner">
        <h2 class="nl-issues-heading">Previous Issues</h2>
        <div class="nl-issues-grid">
          <div class="nl-issue-card"><div class="nl-issue-year">2025</div><div class="nl-issue-links"><a href="#" class="nl-issue-link">2025 Village Newsletter (Q3)</a><a href="#" class="nl-issue-link">2025 Village Newsletter (Q2)</a><a href="#" class="nl-issue-link">2025 Village Newsletter (Q1)</a></div></div>
          <div class="nl-issue-card"><div class="nl-issue-year">2024</div><div class="nl-issue-links"><a href="#" class="nl-issue-link">2024 Village Newsletter (Q4)</a><a href="#" class="nl-issue-link">2024 Village Newsletter (Q2-Q3)</a><a href="#" class="nl-issue-link">2024 Village Newsletter (Q1)</a></div></div>
          <div class="nl-issue-card"><div class="nl-issue-year">2023</div><div class="nl-issue-links"><a href="#" class="nl-issue-link">2023 Village Newsletter (Q3)</a><a href="#" class="nl-issue-link">2023 Village Newsletter (Q2)</a><a href="#" class="nl-issue-link">2023 Village Newsletter (Q1)</a></div></div>
          <div class="nl-issue-card"><div class="nl-issue-year">2022</div><div class="nl-issue-links"><a href="#" class="nl-issue-link">2022 Village Newsletter (Q4)</a><a href="#" class="nl-issue-link">2022 Village Newsletter (Q3)</a><a href="#" class="nl-issue-link">2022 Village Newsletter (Q2)</a><a href="#" class="nl-issue-link">2022 Village Newsletter (Q1)</a></div></div>
          <div class="nl-issue-card"><div class="nl-issue-year">2019 - 2021</div><div class="nl-issue-links"><a href="#" class="nl-issue-link">End of Year 2021 Newsletter</a><a href="#" class="nl-issue-link">Juneteenth 2020 Newsletter</a><a href="#" class="nl-issue-link">Juneteenth 2019 Newsletter</a></div></div>
        </div>
      </div>
    </section>
  </main><!-- /#main-content -->
