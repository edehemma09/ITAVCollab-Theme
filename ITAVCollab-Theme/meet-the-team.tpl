...
<head>
  ...
  <meta name="description" content="Meet the ITAVCollab leadership team and board members." />
  %%wsite_css%%
...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="team-hero-section">
    <img class="team-hero-bg" src="assets/images/team-hero.jpg" alt="ITAVCollab team" />
    <div class="team-hero-overlay">
      <h1 class="team-hero-title">Meet the ITAVCollab Team</h1>
    </div>
  </section>
  <!-- Leadership Team — drag-drop editable in Weebly editor -->
  <div class="wsite-section team-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Board Members — drag-drop editable in Weebly editor -->
  <div class="wsite-section board-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
