...
<head>
  ...
  <meta name="description" content="Healing-centered training and wellness for nonprofits and organizations." />
  %%wsite_css%%
...
<div class="page-wrapper wsite-theme-content">
  ...
  <!-- Why Organizations Partner — drag-drop editable in Weebly editor -->
  <div class="wsite-section ow-why">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- What We Offer — 3 Cards — drag-drop editable in Weebly editor -->
  <div class="wsite-section ow-offer">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Partner Logos — drag-drop editable in Weebly editor -->
  <div class="wsite-section ow-partners">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Become a Partner CTA — drag-drop editable in Weebly editor -->
  <div class="wsite-section ow-cta">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
