...
<head>
  ...
  <title>Organizational Wellness — It Takes A Village Collaborative</title>
  <meta name="description" content="Healing-centered training and wellness experiences for nonprofits and organizations." />
  %%wsite_css%%
...
<!-- 1. HERO -->
    <section class="page-hero" aria-label="Organizational Wellness and Capacity Building">
      <img class="page-hero-bg" src="assets/images/org-wellness-hero.jpg" alt="ITAVCollab organizational wellness event" />
      <div class="page-hero-overlay" aria-hidden="true"></div>
      <div class="page-hero-content">
        <h1 class="page-hero-title">Organizational Wellness &amp; Capacity Building</h1>
        <p class="page-hero-subtitle">Integrating Wellness as a Strategy For Long-Term Impact</p>
      </div>
    </section>

    <!-- 2. WHY ORGANIZATIONS PARTNER WITH US -->
    <section class="ow-why" aria-label="Why Organizations Partner With Us">
      <div class="ow-why-inner">
        <h2 class="ow-section-heading">Why Organizations Partner With Us</h2>
        <p class="ow-body">ITAVCollab partners with nonprofits, foundations, and mission-driven organizations to integrate wellness as a strategy for sustainability and leadership effectiveness. Our <span class="ow-green">Organizational Wellness &amp; Capacity Building program</span> offers healing-centered training and wellness experiences that help organizations prevent burnout, build human-centered cultures, and sustain impact through leadership development, retreats, and professional learning.</p>
      </div>
    </section>

    <!-- 3. WHAT WE OFFER — 3 cards -->
    <section class="ow-offer" aria-label="What We Offer">
      <div class="ow-offer-inner">
        <h2 class="ow-section-heading">What We Offer</h2>
        <div class="ow-offer-grid">

          <div class="ow-offer-card">
            <div class="ow-offer-card-header">Hybrid Team Wellness</div>
            <ul class="ow-offer-list">
              <li>Staff healing circles</li>
              <li>Burnout prevention workshops</li>
              <li>Wellness retreats</li>
              <li>Professional development</li>
            </ul>
          </div>

          <div class="ow-offer-card ow-offer-card--dark">
            <div class="ow-offer-card-header">Leadership Development Cohorts</div>
            <ul class="ow-offer-list">
              <li>Vision alignment</li>
              <li>Human-centered leadership practices</li>
              <li>Sustainable organizational culture building</li>
            </ul>
          </div>

          <div class="ow-offer-card">
            <div class="ow-offer-card-header">Wellness Activations</div>
            <ul class="ow-offer-list">
              <li>Conference sessions</li>
              <li>Staff retreats</li>
              <li>Organizational wellness experiences</li>
            </ul>
          </div>
    ...
    <!-- 4. PARTNERS SECTION -->
    <section class="ow-partners" aria-label="Our Organizational Partners">
      <div class="ow-partners-inner">
        <p class="ow-partners-intro">Thank you to our partners who have participated in our Organizational Wellness &amp; Capacity Building program.</p>
        <div class="ow-partners-grid">
          <div class="ow-partner-logo">
            <img src="assets/logos/partner-confidence-you-services.png" alt="Confidence In You Services" loading="lazy" />
          </div>
          <div class="ow-partner-logo">
            <img src="assets/logos/partner-a-healthier-you.png" alt="A Healthier You Inc" loading="lazy" />
          </div>
          <div class="ow-partner-logo">
    ...
    <!-- 5. PARTNER WITH ITAVCOLLAB CTA -->
    <section class="ow-cta" aria-label="Partner with ITAVCollab">
      <div class="ow-cta-inner">
        <h2 class="ow-cta-heading">Partner with It Takes A Village Collaborative</h2>
        <p class="ow-cta-body">Are you looking to integrate wellness into your organization? Fill out our partner interest form.</p>
