...
<head>
  ...
  <title>%%title%% — It Takes A Village Collaborative</title>
...
<div class="page-wrapper wsite-theme-content">
  ...
  <div class="wsite-section wsite-section-blog-post">
    <div class="wsite-section-content">
      <div class="wsite-content-elem wsite-post-title">
        {element}
      </div>
      <div class="wsite-content-elem wsite-post-body">
        {element}
      </div>
    </div>
  </div>
