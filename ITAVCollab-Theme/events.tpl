...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="ev-hero">
    <img class="ev-hero-bg" src="assets/images/events-hero.jpg" alt="Community at ITAVCollab outdoor event" />
    <div class="ev-hero-title-box">
      <h1 class="ev-hero-title">ITAVCollab Events</h1>
    </div>
  </section>
  <!-- Upcoming Events — 3+1 Card Grid — drag-drop editable in Weebly editor -->
  <div class="wsite-section ev-upcoming">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Notify Me — Form + Image — drag-drop editable in Weebly editor -->
  <div class="wsite-section ev-notify">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
