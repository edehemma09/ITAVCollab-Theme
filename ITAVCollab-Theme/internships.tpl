...
<head>
  ...
  <title>Internships — It Takes A Village Collaborative</title>
  <meta name="description" content="Apply to our internship program in wellness and nonprofit development." />
  %%wsite_css%%
...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="page-hero">
    <img class="page-hero-bg" src="assets/images/internships-hero.jpg" alt="ITAVCollab interns group photo" />
    <div class="page-hero-overlay" aria-hidden="true"></div>
    <div class="page-hero-content">
      <h1 class="page-hero-title">ITAVCollab Internships</h1>
    </div>
  </section>
  <!-- Now Accepting + Body Text + 4 Internship Types — drag-drop editable in Weebly editor -->
  <div class="wsite-section intern-body">
