...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="page-hero">
    <img class="page-hero-bg" src="assets/images/partners-hero.jpg" alt="ITAVCollab partners gathered" />
  ...
  <!-- Why Partner — Text + 5 Cards — drag-drop editable in Weebly editor -->
  <div class="wsite-section pt-why">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Benefits to Collaboration — Alternating Rows — drag-drop editable in Weebly editor -->
  <div class="wsite-section pt-benefits">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Partnership Types — 3 Cards — drag-drop editable in Weebly editor -->
  <div class="wsite-section pt-types">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Partner Logos Grid — drag-drop editable in Weebly editor -->
  <div class="wsite-section pt-logos">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Interested in Becoming a Partner CTA — drag-drop editable in Weebly editor -->
  <div class="wsite-section pt-cta">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
