...
<head>
  ...
  <title>Our Partners — It Takes A Village Collaborative</title>
  <meta name="description" content="Partner with ITAVCollab to advance wellness in your community." />
  %%wsite_css%%
...
<!-- 1. HERO — photo bg, centered title + subtitle + white button -->
    <section class="page-hero" aria-label="Our Partners">
      <img class="page-hero-bg" src="assets/images/partners-hero.jpg" alt="ITAVCollab partners gathered together" />
      <div class="page-hero-overlay" aria-hidden="true"></div>
      <div class="page-hero-content">
        <h1 class="page-hero-title">Our Partners</h1>
        <p class="page-hero-subtitle">Collaboration Expands Access to Healing</p>
        <a href="#partner-form" class="btn btn-white">Become a Partner</a>
      </div>
    </section>

    <!-- 2. WHY PARTNER -->
    <section class="pt-why" aria-label="Why Partner With ITAVCollab">
      <div class="pt-why-inner">
        <h2 class="pt-section-heading">Why Partner With ITAVCollab?</h2>
        <p class="pt-body">Our initiatives are designed to meet our community where they are, addressing the root causes of stress, trauma, and systemic burnout. With your help, we can continue to equip individuals with the tools and support needed to move beyond survival and into thriving.</p>
        <div class="pt-why-grid">
          <div class="pt-why-card">Expand access to culturally competent care</div>
          <div class="pt-why-card">Support justice-impacted communities</div>
          <div class="pt-why-card">Strengthen community health ecosystems</div>
          <div class="pt-why-card">Co-create wellness programming</div>
          <div class="pt-why-card">Advance healing-centered care models</div>
        </div>
      </div>
    </section>

    <!-- 3. BENEFITS TO COLLABORATION — alternating rows -->
    <section class="pt-benefits" aria-label="Benefits to Collaboration">
      <div class="pt-benefits-inner">
        <h2 class="pt-section-heading">Benefits to Collaboration</h2>
        <p class="pt-body">We partner with organizations, businesses, and community leaders committed to advancing culturally competent wellness and community transformation. By partnering with ITAVCollab, your organization will gain:</p>

        <!-- Row 1: image left, text right -->
        <div class="pt-benefit-row">
          <div class="pt-benefit-image">
            <img src="assets/images/partners-trusted.jpg" alt="Community members at an ITAVCollab event" loading="lazy" />
          </div>
          <div class="pt-benefit-content">
            <h3 class="pt-benefit-heading">Trusted Community Access</h3>
            <p class="pt-benefit-body">Partner with a respected, community-based organization with deep, authentic relationships and strong credibility across Black and justice-impacted communities.</p>
          </div>
        </div>

        <!-- Row 2: text left, image right -->
        <div class="pt-benefit-row pt-benefit-row--reverse">
          <div class="pt-benefit-content">
            <h3 class="pt-benefit-heading">Aligned Social Impact</h3>
            <p class="pt-benefit-body">Demonstrate a visible commitment to equity, wellness, and community healing through programs that create real, measurable impact.</p>
          </div>
          <div class="pt-benefit-image">
            <img src="assets/images/partners-bridge.jpg" alt="ITAVCollab community partner event" loading="lazy" />
          </div>
        </div>
        ...
        <div class="pt-benefit-row">
          <div class="pt-benefit-image">
            <img src="assets/images/partners-trusted.jpg" alt="ITAVCollab bridge to resources event" loading="lazy" />
          </div>
          <div class="pt-benefit-content">
            <h3 class="pt-benefit-heading">Bridge to Resources &amp; Opportunity</h3>
            <p class="pt-benefit-body">Help expand access to holistic wellness pathways, support services, and community resources for underserved populations.</p>
          </div>
        </div>
    ...
    <!-- 4. PARTNERSHIP TYPES -->
    <section class="pt-types" aria-label="Partnership Types">
      <div class="pt-types-inner">
        <h2 class="pt-section-heading">Partnership Types</h2>
        <p class="pt-body">Partner with ITAVCollab as a Collaborator, Sponsor, or Community Partner.</p>
        <div class="pt-types-grid">
          <div class="pt-type-card">
            <h3 class="pt-type-name">Collaborator</h3>
            <p class="pt-type-desc">Co-create wellness experiences and community programming.</p>
          </div>
          <div class="pt-type-card">
            <h3 class="pt-type-name">Sponsor</h3>
            <p class="pt-type-desc">Provide financial or in-kind support to sustain initiatives.</p>
          </div>
          <div class="pt-type-card pt-type-card--green">
            <h3 class="pt-type-name">Community Partner</h3>
            <p class="pt-type-desc">Integrate healing-centered wellness into your organization's work.</p>
          </div>
        </div>
      </div>
    </section>

    <!-- 5. OUR PARTNERS LOGOS -->
    <section class="pt-logos" aria-label="Our Partners">
      <div class="pt-logos-inner">
        <h2 class="pt-section-heading">Our Partners</h2>
        <p class="pt-body">Thank you to our current It Takes A Collaborative partners.</p>
        <div class="pt-logos-grid">
          <div class="pt-logo-item"><img src="assets/logos/partner-confidence-you-services.png" alt="Confidence In You Services" loading="lazy" /></div>
          <div class="pt-logo-item"><img src="assets/logos/partner-a-healthier-you.png" alt="A Healthier You Inc" loading="lazy" /></div>
          <div class="pt-logo-item"><img src="assets/logos/partner-my-community-clinic.png" alt="Ivy Community Clinic" loading="lazy" /></div>
          <div class="pt-logo-item"><img src="assets/logos/partner-lee.png" alt="LEE" loading="lazy" /></div>
          <div class="pt-logo-item"><img src="assets/logos/partner-mettie-works.png" alt="Mettle Works" loading="lazy" /></div>
          <div class="pt-logo-item"><img src="assets/logos/partner-the-community-clinic.png" alt="National Reentry Network" loading="lazy" /></div>
          <div class="pt-logo-item"><img src="assets/logos/partner-elevate-prince-georges.png" alt="Elevate Prince George's" loading="lazy" /></div>
          <div class="pt-logo-item"><img src="assets/logos/partner-vsc.png" alt="VSC" loading="lazy" /></div>
        </div>
        <div class="pt-logo-xispossible">
    ...
    <!-- 6. INTERESTED CTA -->
    <section class="pt-cta" id="partner-form" aria-label="Interested in Becoming a Partner">
      <div class="pt-cta-inner">
        <h2 class="pt-cta-heading">Interested in Becoming a Partner?</h2>
        <p class="pt-cta-body">Fill out our partner interest form and let's start a conversation.</p>
        <a href="connect.html" class="btn btn-green">Become a Partner</a>
      </div>
    </section>
  </main><!-- /#main-content -->
