...
<head>
  ...
  <title>Page Not Found — It Takes A Village Collaborative</title>
...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="coming-soon-section">
    <div class="coming-soon-inner">
      <h1 class="coming-soon-heading">Page Not Found</h1>
      <p class="coming-soon-body">The page you are looking for could not be found.<br/>Please check the URL or return to our homepage.</p>
      <a href="/" class="btn btn-green">Back to Home</a>
    </div>
  </section>
