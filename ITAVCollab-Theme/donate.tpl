...
<div class="page-wrapper wsite-theme-content">
  ...
  <!-- HERO — fixed donate style -->
  <section class="donate-hero">
    <img class="donate-hero-bg" src="assets/images/donate-hero.jpg" alt="Community members at ITAVCollab event" />
  ...
  <!-- When Traditional Systems Fail — drag-drop editable in Weebly editor -->
  <div class="wsite-section donate-systems">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Why Your Gift Matters — Image + Text — drag-drop editable in Weebly editor -->
  <div class="wsite-section donate-why">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Support Cards — 4 Col Grid — drag-drop editable in Weebly editor -->
  <div class="wsite-section donate-support-cards">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Become A Village Keeper — Image + Text — drag-drop editable in Weebly editor -->
  <div class="wsite-section donate-keeper">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Impact Cards — 2x2 Grid — drag-drop editable in Weebly editor -->
  <div class="wsite-section donate-impact">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Village Needs Your Support — Image + Text — drag-drop editable in Weebly editor -->
  <div class="wsite-section donate-village">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Other Ways to Get Involved CTA — drag-drop editable in Weebly editor -->
  <div class="wsite-section donate-other">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
