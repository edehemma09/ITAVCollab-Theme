...
<head>
  ...
  <title>Blog — It Takes A Village Collaborative</title>
  <meta name="description" content="Stories, insights, and updates from the ITAVCollab community." />
  %%wsite_css%%
...
<!-- HERO -->
    <section class="page-hero" aria-label="Blog">
      <img class="page-hero-bg" src="assets/images/hero-background.png" alt="Blog" />
      ...
      <div class="coming-soon-inner">
        <div class="coming-soon-icon" aria-hidden="true">
          <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="32" cy="32" r="30" stroke="#29741D" stroke-width="3"/>
            <path d="M32 18v16l10 6" stroke="#29741D" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
        </div>
        <h2 class="coming-soon-heading">Coming Soon</h2>
        <p class="coming-soon-body">Stories, insights and updates from our community.<br/><br/>We are actively working on this page. Check back soon or <a href="newsletter.html" class="coming-soon-link">subscribe to our newsletter</a> to be notified when it launches.</p>
