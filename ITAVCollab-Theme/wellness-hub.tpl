...
<div class="page-wrapper wsite-theme-content">
  ...
  <section class="page-hero">
    <img class="page-hero-bg" src="assets/images/wellness-hub-hero.jpg" alt="Two people sitting on grass" />
  ...
  <!-- Intro + Category Nav Buttons — drag-drop editable in Weebly editor -->
  <div class="wsite-section wh-intro">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Mental Health Care Resources — drag-drop editable in Weebly editor -->
  <div class="wsite-section wh-category-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Physical Health Care Resources — drag-drop editable in Weebly editor -->
  <div class="wsite-section wh-category-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Spiritual &amp; Holistic Care — drag-drop editable in Weebly editor -->
  <div class="wsite-section wh-category-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- ITAVCollab Community Care — drag-drop editable in Weebly editor -->
  <div class="wsite-section wh-community-section">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
  <!-- Not Seeing What You Need CTA — drag-drop editable in Weebly editor -->
  <div class="wsite-section wh-not-seeing">
    <div class="wsite-section-content">
      {element}
    </div>
  </div>
